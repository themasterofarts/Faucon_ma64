...
class CmdVelToJoints2WS(Node):
    def __init__(self):
        super().__init__("cmd_vel_based_2ws_control")

        get_logger = self.get_logger()
        get_logger.info("2WS Control Node Initialized (Front Steering Only)")
    ...
    def cmd_vel_cb(self, msg: Twist):
        ...
        # 2WS: Front steering only, Rear steering fixed at 0.0
        ...
        # Ordering: Left Front, Right Front, Left Rear, Right Rear
