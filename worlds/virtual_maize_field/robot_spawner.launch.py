...
def generate_launch_description() -> LaunchDescription:
    ...
    x = LaunchConfiguration("x", default="-1.9058650882723436")
    y = LaunchConfiguration("y", default="-3.011211298686556")
    ...
    yaw = LaunchConfiguration("Y", default="1.6007087975256085")
